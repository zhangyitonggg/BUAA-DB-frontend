...
const api = {
  ...
  getTasks: async(tags, sort_by, key_word, page) => { return await router.get(path.baseUrl + path.tasks.search, {params: {page: page, per_page: 30, sort_by: sort_by, key_word: key_word, tags: tags, max_length: 30}}); },
